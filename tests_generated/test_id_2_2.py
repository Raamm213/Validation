...
OPTIONAL_FIELDS = ["Revenue", "Number of Employees", "Sector Description", "Growth Metrics", "Hiring Velocity"]
...
def dataset():
    return Dataset(parameters=[
        Parameter("P001", "Company Name", "Tiny Startup LLC", {}),
        Parameter("P002", "Category", "Tech", {}),
        Parameter("P003", "Year of Incorporation", "2022", {}),
        Parameter("P004", "Revenue", "", {}),
        Parameter("P005", "Number of Employees", "", {}),
        Parameter("P006", "Sector Description", "", {}),
        Parameter("P007", "Growth Metrics", "", {}),
        Parameter("P008", "Hiring Velocity", "", {}),
    ])
