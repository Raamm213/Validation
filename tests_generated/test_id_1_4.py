...
def tc_1_4_companyname_01_validator(param: Parameter):
    value = param.value
    if value not in OFFICIAL_COMPANY_NAMES:
        return (
...
LEGAL_SUFFIXES = ["Inc.", "Ltd.", "Corp.", "LLC"]
...
def dataset():
    return Dataset(parameters=[
        Parameter("P001", "Company Name", "Microsft Corporation", {}),
        Parameter("P002", "Company Name", "App", {}),
        Parameter("P003", "Company Name", "Goog", {}),
        Parameter("P004", "Company Name", "Mikrosoft Corp", {}),
        Parameter("P005", "Company Name", "Tesla", {})
    ])
...
# P001=Microsft Corporation, P002=App, P003=Goog, P004=Mikrosoft Corp, P005=Tesla.
# TC-02: below min words -> P002, P003, P005.
# TC-05: LEGAL_SUFFIXES are ["Inc.", "Ltd.", "Corp.", "LLC"] (with period); "Mikrosoft Corp" has no period so all 5 fail.
