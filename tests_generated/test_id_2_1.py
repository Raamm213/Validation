...
MANDATORY_FIELDS = ["Company Name", "Category", "Year of Incorporation", "Logo", "Headquarters"]
...
OPTIONAL_FIELDS = ["Revenue", "Number of Employees", "Sector Description", "Growth Metrics"]
...
def dataset():
    return Dataset(parameters=[
        ...
        Parameter("P002", "Category", "Technology", {}),
        Parameter("P003", "Year of Incorporation", "1975", {}),
        Parameter("P004", "Logo", "https://example.com/logo.png", {}),
        Parameter("P005", "Headquarters", "Redmond, WA", {}),
        Parameter("P006", "Revenue", "168B", {}),
        Parameter("P007", "Number of Employees", "181000", {}),
        Parameter("P008", "Sector Description", "Software", {}),
        Parameter("P009", "Growth Metrics", "10% YoY", {}),
        # Add more parameters to simulate ~150+ schema fields
    ])
